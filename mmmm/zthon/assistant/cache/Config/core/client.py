                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        ftext = f"\nيتم تحميل هذا الملف فقط هنا ،\
                                  ...
                                  \n\nنحن نحترم خصوصيتك.\
                                  \n\nفقـط قـم بإعـادة توجيـه هـذه الرسـالة إلى مطـور السـورس @SS22TT\
                                  \n\n--------بـدء تتبـع سجـل سيـفت--------\
                        ...
                        link = "[المطور](https://t.me/SS22TT)"
                        text = (
                            "**✘ تقـريـر اشعـار سيـفت ✘**\n\n"
